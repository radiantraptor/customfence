...
import com.raptor.customfence.config.ConfigHandler;
import com.raptor.customfence.init.*;
...
public class Main {
    ...
    public Main(IEventBus modEventBus, ModContainer modContainer) {
        ...
        ModItemTabs.CREATIVE_TAB_WOODEN_FENCES.register(modEventBus);
        ...
        ModBlocksWoodenFence.register(modEventBus);
        ModBlocksWall.register(modEventBus);
        ModBlocksMetalFence.register(modEventBus);

        System.out.println("################## "+ConfigHandler.COMMON.more_creative_tabs);
